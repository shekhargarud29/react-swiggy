...
const Header = () => {
  ...
  return (
    ...
    >
      <div className=" ">
        <nav
          className="align-items-center d-flex mx-auto  py-1"
        ...
        >
          ...
          <div
            ...
            style={{ padding: "15px" }}
          >
            <Link to="/" className="me-4 " title="Swiggy">
              <span>
                <svg
                  className="_8pSp-"
                  viewBox="0 0 559 825"
            ...
            <Link to={"/"} className=" mx-4">
              <h6 className="m-0 fw-bold header">Other</h6>
              <div
                className="mt-1"
                style={{ backgroundColor: "black", padding: "1px" }}
              ></div>
            </Link>
            <i
              // className="fa-solid fa-chevron-down text-warning h4"
              className="fa-solid fa-chevron-down text-warning fw-bold fs-6"
            ></i>
            {/* </h6> */}
          </div>
              ...
              >
                <ul className="navbar-nav ">
                  {headers.map((head, index) => {
                    const { name, logo, link } = head;
                    return (
                      <>
                        <li key={`V${index}`} className="nav-item  mx-4">
                          <Link
