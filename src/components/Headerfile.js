      ...
      <div className="header">
        <header class="_76q0O">
          <div class="global-nav">
            <div class="_1EuBh">
              <a href="/" class="d9y3g" title="Swiggy">
                <svg
                  class="_8pSp-"
                  viewBox="0 0 559 825"
                  height="49"
              ...
              <div role="button" class="_2z2N5" tabindex="0">
                <span class="_1tcx6">
                  <span class="_3odgy">Other</span>
                </span>
                <span class="_3HusE"></span>
              ...
              <ul class="_1JNGZ">
                ...
                <li class="_1fo6c">
                  <div class="_2CgXb">
                    <a class="_1T-E4" href="/about-us" target="_blank">
                      <span class="_3yZyp">
                        <svg
                          class="_1GTCc"
                          viewBox="0 0 20 20"
