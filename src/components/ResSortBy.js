        ...
        <ul className="dropdown-menu p-3 rounded-4 shadow">
          <li>
            <div className="d-flex align-items-center p-1 justify-content-between">
              <label className="flex-fill pe-3" htmlFor="Relevance(Default)">
                Relevance(Default)
              </label>
              <input
          ...
          <li>
            <div className="d-flex align-items-center p-1 justify-content-between">
              <label className="flex-fill" htmlFor="DeliveryTime">
                DeliveryTime
              </label>
              <input
                className=" input-button"
          ...
          <li>
            <div className="d-flex align-items-center p-1 justify-content-between">
              <label className="flex-fill" htmlFor="Rating">
                Rating
              </label>
              <input
                className=" input-button "
          ...
          <li>
            <div className="d-flex align-items-center p-1 justify-content-between">
              <label className="flex-fill" htmlFor="Cost:LowtoHigh">
                Cost:LowtoHigh
              </label>
              <input
                className=" input-button "
          ...
          <li>
            <div className="d-flex align-items-center p-1 justify-content-between">
              <label className="flex-fill" htmlFor="Cost:HightoLow">
                Cost:HightoLow
              </label>
              <input
                className=" input-button "
